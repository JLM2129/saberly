...
INSTALLED_APPS = [
    ...
    # Local apps
    'apps.users',
    'apps.preguntas.apps.PreguntasConfig',
    'apps.simulacros',
    'apps.estadisticas',
    'apps.juegos',
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Saberly API',
    'DESCRIPTION': 'API para la aplicación de preparación ICFES Saberly',
    'VERSION': '1.0.0',
...
# CORS Config
CORS_ALLOW_ALL_ORIGINS = True # For dev convenience with React Native
